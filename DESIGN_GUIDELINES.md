...
## Icons
All icons are pdc icons. This way we can scale the icon easily to e.g. emery without having something pixelized. Also whenever an icon is interactive (e.g. the battery icon), the interactive part is gray.
